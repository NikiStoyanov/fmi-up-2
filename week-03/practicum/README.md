...
**Задача 15:** От конзолата се въвежда число k. След това се въвежда поредица от числа, докато не се въведе 0. Вашата задача е да отпечатате колко от въведените числа са suffix на k. Отпечатайте също и максималният suffix.
...
**Задача 17.** Да се напише програма, която приема цяло положително число n и отпечатва следната папионка:
